...
class MatchStateManager:
    ...
    def get_state(self, guild_id: Optional[int] = None) -> Optional[MatchState]:
        """
    ...
    def set_state(self, guild_id: Optional[int], state: MatchState) -> None:
        """
    ...
    def clear_state(self, guild_id: Optional[int]) -> None:
        """
    ...
    def has_pending_match(self, guild_id: Optional[int] = None) -> bool:
