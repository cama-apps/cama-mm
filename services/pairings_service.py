...
class PairingsService:
    ...
    def get_best_teammates(
        ...
        return self.pairings_repo.get_best_teammates(discord_id, guild_id=normalize_guild_id(guild_id), min_games=min_games, limit=limit)

    def get_worst_teammates(
        self, discord_id: int, guild_id: int | None = None, min_games: int = 3, limit: int = 5
    ) -> list[dict]:
        """Get players with lowest win rate when on the same team."""
        return self.pairings_repo.get_worst_teammates(discord_id, guild_id=normalize_guild_id(guild_id), min_games=min_games, limit=limit)

    def get_best_matchups(
        self, discord_id: int, guild_id: int | None = None, min_games: int = 3, limit: int = 5
    ) -> list[dict]:
        """Get opponents with highest win rate against."""
        return self.pairings_repo.get_best_matchups(discord_id, guild_id=normalize_guild_id(guild_id), min_games=min_games, limit=limit)

    def get_worst_matchups(
        self, discord_id: int, guild_id: int | None = None, min_games: int = 3, limit: int = 5
    ) -> list[dict]:
        """Get opponents with lowest win rate against."""
        return self.pairings_repo.get_worst_matchups(discord_id, guild_id=normalize_guild_id(guild_id), min_games=min_games, limit=limit)
    ...
    def get_most_played_with(
        ...
        return self.pairings_repo.get_most_played_with(discord_id, guild_id=normalize_guild_id(guild_id), min_games=min_games, limit=limit)

    def get_most_played_against(
        self, discord_id: int, guild_id: int | None = None, min_games: int = 1, limit: int = 5
    ) -> list[dict]:
        """Get players played against most often."""
        return self.pairings_repo.get_most_played_against(discord_id, guild_id=normalize_guild_id(guild_id), min_games=min_games, limit=limit)
    ...
    def get_evenly_matched_teammates(
        ...
        return self.pairings_repo.get_evenly_matched_teammates(
            discord_id, guild_id=normalize_guild_id(guild_id), min_games=min_games, limit=limit
        )
    ...
    def get_pairing_counts(
        ...
        return self.pairings_repo.get_pairing_counts(discord_id, guild_id=normalize_guild_id(guild_id), min_games=min_games)
