...
RANDOM_EVENTS: list[RandomEvent] = [
    ...
    RandomEvent(
        ...
        description=(
            "The dark down here has a preference. It drifts, slow and certain, toward the heaviest purses in the mine.",
            "A cold pressure builds in the tunnel — pointed away from you, toward whoever is holding the most.",
            "Something in the black is sniffing for weight. You aren't carrying enough to interest it. Yet.",
        ),
        min_depth=10, max_depth=None,
        safe_option=EventChoice(
            "Stay small and quiet",
            success=EventOutcome("You keep your head down and let it drift past. You're not worth its hunger.", 0, 4, False),
            failure=None, success_chance=1.0,
        ),
        risky_option=EventChoice(
            "Point it uphill at the rich",
            success=EventOutcome("You turn its hunger toward the fattest stashes in the deep. The cold takes its bite from them.", 0, 5, False),
            failure=EventOutcome("It turns on you instead. Briefly. Rudely.", 0, -5, False),
            success_chance=0.60,
        ),
        rarity="uncommon",
        social=True,
    ...
    RandomEvent(
        ...
        name="Deny the Seam",
        description=(
            "A seam of pure ore runs off toward a wealthier claim than yours. You could work it quietly — or bring the roof down so no one richer ever gets it.",
            "The vein is good, and it isn't only yours. There's a way to make sure it stays no one's.",
            "Someone with deeper pockets has been mining toward this exact seam. You got here a few swings ahead.",
        ),
        min_depth=20, max_depth=None,
        safe_option=EventChoice(
            "Work it quietly",
            success=EventOutcome("You chip out a modest share and move on before anyone notices.", 0, 4, False),
            failure=None, success_chance=1.0,
        ),
        risky_option=EventChoice(
            "Bring the seam down",
            success=EventOutcome("You collapse the whole seam into dead rock. Somewhere above, a very fat claim just got lighter.", 0, 6, False),
            failure=EventOutcome("The collapse catches your own footing. You limp off with less than you came with.", 0, -6, False),
            success_chance=0.60,
        ),
        rarity="uncommon",
        social=True,
    ...
    RandomEvent(
        ...
        name="Turf War",
        description=(
            "Two things far bigger than you are fighting over this stretch of dark. The walls are not going to survive it.",
            "A roar answers a roar. The tunnel between them — where you happen to be standing — is about to become collateral.",
            "Two apex things have claimed the same ground. You can use that, if you're quick and stupid in the right order.",
        ),
        min_depth=35, max_depth=None,
        safe_option=EventChoice(
            "Back out of their way",
            success=EventOutcome("You give the brawl a wide berth and pocket what you can on the way out.", 0, 6, False),
            failure=None, success_chance=1.0,
        ),
        risky_option=EventChoice(
            "Bait them together and run",
            success=EventOutcome("They crash together right where you wanted. The shockwave buries stashes for half the deep.", 0, 8, False),
            failure=EventOutcome("You misjudge the timing. One of them turns on you instead.", 0, 0, True),
            success_chance=0.58,
        ),
        rarity="uncommon",
        social=True,
    ...
    RandomEvent(
        ...
        name="Smoke Ambush",
        description=(
            "A bank of grey haze fills the tunnel. Move through it and nobody will see you coming.",
            "The smoke swallows your lantern and your footsteps both. Somewhere ahead, a digger works with their back turned.",
            "Cover, thick and sudden. Whatever you do in here, no one will be able to swear it was you.",
        ),
        min_depth=60, max_depth=None,
        safe_option=EventChoice(
            "Wait for it to clear",
            success=EventOutcome("You let the haze settle before moving on. Slow, but clean.", 0, 6, False),
            failure=None, success_chance=1.0,
        ),
        risky_option=EventChoice(
            "Move through the smoke",
            success=EventOutcome("You're on them before they hear you. In the scramble their coin scatters into cracks no one will ever reach.", 0, 10, False),
            failure=EventOutcome("The haze thins at the worst moment. They see you first, and you pay for it.", 0, -10, False),
            success_chance=0.55,
        ),
        rarity="rare",
        social=True,
    ...
    RandomEvent(
        ...
        name="The Tear",
        description=(
            "A seam of absolute black opens where solid rock should be. It is not empty. It is hungry, and it is whispering.",
            "Something behind the dark leans closer when you go still. It wants what everyone up there is carrying.",
            "The tear breathes. The whispers know your name, and several others besides.",
        ),
        min_depth=90, max_depth=None,
        safe_option=EventChoice(
            "Seal it over",
            success=EventOutcome("You wall it back up. The whispering fades, reluctantly.", 0, 6, False),
            failure=None, success_chance=1.0,
        ),
        risky_option=EventChoice(
            "Let it open",
            success=EventOutcome("It feeds. Across the deep, a dozen purses lighten by exactly the weight the dark decides to take.", 0, 10, False),
            failure=EventOutcome("It closes before it can feed. You lose your bearings in the dark it leaves behind.", 0, 0, False, streak_loss=3),
            success_chance=0.50,
        ),
        rarity="rare",
        social=True,
    ...
    RandomEvent(
        ...
        description=(
            "Something enormous has been pacing the deepest tunnels. It hunts whatever has gone furthest down.",
            "Claw-marks the size of doors. Whatever left them prefers the bold — the ones who dig deepest.",
            "It's tracking the deepest scent in the mine. That isn't you. Not yet.",
        ),
        min_depth=110, max_depth=None,
        safe_option=EventChoice(
            "Stay shallow of it",
            success=EventOutcome("You keep above its hunting line and slip away unnoticed.", 0, 8, False),
            failure=None, success_chance=1.0,
        ),
        risky_option=EventChoice(
            "Turn it toward the deep",
            success=EventOutcome("You point it at the deepest trail in the mine and carve your cut from the wreckage it leaves behind.", 0, 12, False),
            failure=EventOutcome("It loses the deeper scent and circles back to the nearest one. Yours.", 0, 0, True),
            success_chance=0.50,
        ),
        rarity="rare",
        social=True,
