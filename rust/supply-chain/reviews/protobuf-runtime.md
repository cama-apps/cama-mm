...
MIT license is retained in LICENSE.txt. The [vendored directory](../../vendor/protobuf) contains the archive's
...
connection was made. The required repository dependency policy and
snapshot verification must cover this local source rather than granting an exemption
