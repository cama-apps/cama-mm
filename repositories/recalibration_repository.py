...
class RecalibrationRepository(BaseRepository, IRecalibrationRepository):
    ...
    def get_state(self, discord_id: int) -> dict | None:
        ...
        with self.connection() as conn:
            ...
            cursor.execute(
                """
                SELECT discord_id, last_recalibration_at, total_recalibrations,
        ...
        with self.connection() as conn:
            ...
            cursor.execute(
                ...
                INSERT INTO recalibration_state (
                    discord_id, last_recalibration_at, total_recalibrations,
                ...
                """,
                (discord_id, last_recalibration_at, total_recalibrations, rating_at_recalibration),
            )
