"""
End-to-end tests covering external integrations and balanced real-world flows.

Sections:
  - OpenDota integration (from test_e2e_opendota.py)
  - Real-world balanced shuffle scenario (from test_e2e_real_world.py)
"""
...
class TestE2EOpenDotaIntegration:
...
# =============================================================================
# Section: Real-world balanced shuffle scenario (from test_e2e_real_world.py)
# =============================================================================
