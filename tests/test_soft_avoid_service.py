...
def test_create_or_extend_avoid_delegates(repo_db_path):
    repo = SoftAvoidRepository(repo_db_path)
    service = SoftAvoidService(repo)

    avoid = service.create_or_extend_avoid(
