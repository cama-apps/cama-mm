...
class TestRealWorldScenario:
    ...
    def test_balanced_shuffle_real_world_example(self, test_db, mock_lobby_manager):
        ...
        for pid in dire_team_ids:
            ...
            assert player.losses == 0, f"Dire player {pid} should have 0 losses, got {player.losses}"
        ...
        for pid in radiant_team_ids:
            ...
            assert player.losses == 1, f"Radiant player {pid} should have 1 loss, got {player.losses}"
        ...
        for pid, team_num, won in dire_participants:
        ...
        for pid, team_num, won in radiant_participants:
        ...
        assert value_diff < 10, f"Value difference should be small (like 2 in example), got {value_diff}"
