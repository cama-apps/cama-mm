...
class TestConfigDefaultValue:
    ...
    def test_config_default_value(self):
        """Verify default recent_match_penalty_weight is 230.0."""
        assert "recent_match_penalty_weight" in SHUFFLER_SETTINGS
        assert SHUFFLER_SETTINGS["recent_match_penalty_weight"] == 230.0
...
class TestShufflerInit:
    ...
    def test_shuffler_uses_default_from_config(self):
        ...
        assert shuffler.recent_match_penalty_weight == 230.0
