...
class TestRatingUpdates:
    ...
    def test_rating_update_after_match(self, test_db):
        ...
        test_db.update_player_glicko_rating(player1_id, player1_glicko.rating, player1_glicko.rd, player1_glicko.vol)
        test_db.update_player_glicko_rating(player2_id, player2_glicko.rating, player2_glicko.rd, player2_glicko.vol)
