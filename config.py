...
LUKE_DISCORD_ID: int | None = _parse_int("LUKE_DISCORD_ID", 0) or None
ASH_DISCORD_ID: int | None = _parse_int("ASH_DISCORD_ID", 0) or None
...
WITCHS_CURSE_LOSS_TRIGGER_PCT = _parse_int("WITCHS_CURSE_LOSS_TRIGGER_PCT", 20)
WITCHS_CURSE_WIN_TRIGGER_PCT = _parse_int("WITCHS_CURSE_WIN_TRIGGER_PCT", 5)
